...
Use these settings with methods such as `ui.addText()`, `ui.addImage()`, `ui.addShape()`, `ui.addBar()`, `ui.addLine()`, and `ui.addRoundLine()` to control positioning, visibility, interactivity, and tooltips.
