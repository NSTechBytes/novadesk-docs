...
<Method
  signature="app.getProductVersion()"
...
<Method
  signature="app.getNovadeskVersion()"
...
>
  <ReturnValue type="string">
    The original Novadesk version string.
  </ReturnValue>
...
>
  <ReturnValue type="string">
    The absolute path to the AppData directory.
  </ReturnValue>
...
<Method
  signature="app.getSettingsFilePath()"
